/**
 * Budget --- An object that will act as a budget with its own category name,
 * limit, and
...
public class Budget {
     ...
     * category and the limit of the budget. The budget amount is automatically set
     * to 0.
     * 
     ...
     */
    public void summary() {
        // Add print statements that display the budget category, budget limit, and
        // current budget amount
        // Add print statement that warns the user if they have exceeded the limit or
        // congratulates user for staying under limit
    }
